...
public function creatclient(Request $request){
  ...
  //$path = $request->file('picture')->store('avatars');   
        ...
        $keys = ['societe', 'nom_prenom', 'adresse', 
        'telephone', 'remarque' ];
...
->all();
  ...
  public function updatesolde(Request $request)
  {
    ...
    if ($request['action'] == 'modifier') {
      ...
      DB::table('cache_tables')->where('id', '=', $request['id_operation'])->update(['id_client' => $request['nom_benef'], 'phone_benef' => $request['phone_benef'], 'montant' => $montant_apres]);
      //dd($request);
 ...
 // dd($request);
  ...
  public function virement()
  {
    ...
    return view('cache-mgmt/virement', [
      'cashout' => $cashout,
