                        ...
                        <div class="form-group">
                            ...
                            <div class="controls{{$errors->has('amount_type')?' has-error':''}}">
                                <select name="amount_type" id="amount_type" class="form-control" >
                                    <option value="Percentage" {{ $edit_coupons->amount_type=='Percentage' ? 'selected': '' }}>Pourcentage (%)</option>
                                    <option value="Montant" {{ $edit_coupons->amount_type=='Montant' ? 'selected': '' }}>Monant (€)</option>
                                </select>
                            ...
                            <div class="controls{{$errors->has('expiry_date')?' has-error':''}}">
                                <div class="input-prepend">
                                    <div data-date="12-02-2012" class="input-append date datepicker">
                                        <input type="text" name="expiry_date" id="expiry_date" value="{{$edit_coupons->expiry_date}}" data-date-format="yyyy-mm-dd" class="span11"  placeholder="yyyy-mm-dd">
