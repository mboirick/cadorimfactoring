...
<div class="row">
  ...
  <div class="box">
    ...
    <div class="box-body">
      ...
      <form method="POST" action="{{route('searchcompte')}}">
        {{ csrf_field() }}
        @component('layouts.searchsolde', ['title' => 'Search'])
        @component('layouts.solde-search-row', ['items' => ['Societe', 'Email', 'Telephone'],
            ...
            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="hidden-xs"> <a href=" {{ route('paiement-management.crediter', ['id' => $client->id_client]) }}" class="btn btn-success">
                      Crediter
                    </a> | <a href=" {{ route('paiement-management.debiter', ['id' => $client->id_client]) }}" class="btn btn-warning">
                      Debiter
                    </a></td>
                  <td class="hidden-xs">

                    <a href=" {{ route('paiement-management.clientstory', ['id' => $client->id_client]) }}" class="btn btn-info">
                      Story
                    </a>

                  </td>

                  <td class="hidden-xs"><a href=" {{ route('paiement-management.editClient', ['id' => $client->id_client]) }}" class="btn btn-danger">
                      Edit
                    </a></td>
