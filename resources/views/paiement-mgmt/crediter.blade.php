    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Créditer </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('paiement-management.addmontant') }}">
                        {{ csrf_field() }}

                        <div class="form-group">
                            
                            <div class="col-md-6">
                                <b>Compte à créditer :{{ $debiteur->firstname}}</b>
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="form-group{{ $errors->has('beneficiaire') ? ' has-error' : '' }}">
                            <label for="benef" class="col-md-4 control-label">Compte debiteur</label>
