  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('cache-management.searchabonnes') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.abonnes-search-row', ['items' => ['Nom', 'Prenom', 'Telephone'], 
          'oldVals' => [isset($searchingVals) ? $searchingVals['Nom'] : '', isset($searchingVals) ? $searchingVals['Prenom'] : '' , isset($searchingVals) ? $searchingVals['Telephone'] : '']])
          @endcomponent
        @endcomponent
      </form>
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row" style="background: #000; color :#fff">
                <th width="10%" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Picture: activate to sort column descending" aria-sort="ascending">Date</th>
                ...
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Prénom</th>
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending">Telephone</th>
