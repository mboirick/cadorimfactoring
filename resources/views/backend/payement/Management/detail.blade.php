        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('payement.transaction')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6" style="text-align:center;">
                                ...
                                |
                                <a href="{{route('payement.waiting')}}" class="btn btn-danger">
                                    Annuler
                                </a>
                            </div>
