    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-sm-2"> <a href="{{ url('reduce/create') }}" class=" btn btn-primary"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span>Cree un promo </a></div>
            </div>
            <br>
                    ...
                    <div class="col-sm-12">
                        <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                           ...
                           reduce/delete         @else
                                    ...
                                    <td class="hidden-xs">
                                        <a href="{{route('reduce.edit',$promo->id)}}" class="btn btn-success btn-mini">Edit</a>
                                        <a href="javascript:" rel="{{$promo->id}}" rel1="reduce/delete" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
