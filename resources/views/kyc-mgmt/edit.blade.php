                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('user-management.update', ['id' => $user->id]) }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="../../{{$user->username }}" width="50px" height="50px"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="type" id="type">
                                    ...
                                    <option value="operateur" {{$user->user_type == 'operateur' ? 'selected' : ''}}>Operateur</option>
                                    <option value="client" {{$user->user_type == 'client' ? 'selected' : ''}}>Gestionnaire Client</option>
                                    <option value="cash" {{$user->user_type == 'cash' ? 'selected' : ''}}>Comptable</option>
                                </select>
                            </div>
                        </div>
