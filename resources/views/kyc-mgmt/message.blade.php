                                                                        ...
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center">
                                                                            <tr>
                                                                                <td style="text-align: center;width: 100%;">
                                                                                    <p style="text-align: center;font-size: 24px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;">Bonjour </p>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align: center;width: 100%;">
                                                                                    <p style="text-align: justify;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto">
                                                                                        Merci d'avoir rempli le formulaire KYC en ligne et de nous avoir soumis vos pi&#233;ces justificatives. Notre &#233;quipe de conformit&#233; examine actuellement votre demande.
                                                                                    </p>
                                                                                    </br>
                                                                                    <p style="text-align: left;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto">
                                                                                        Si notre &#233;quipe a d'autres questions, elle vous contactera.
                                                                                    </p>
                                                                                    </br>
                                                                                    <p style="text-align: left;font-size: 18px;font-family: 'Montserrat Light', sans-serif;color: #989898;line-height: 1.5;;width: 90%;margin: auto">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center;background-color: transparent">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="text-align: center;"><span style="font-size: 10px;color: #999999;font-family: 'Montserrat Light', sans-serif;">Copyright © 2020 cadorim.com. All Rights Reserved.</span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
