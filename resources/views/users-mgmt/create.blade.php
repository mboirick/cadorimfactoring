                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('user-management.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('username') ? ' has-error' : '' }}">
                            <label for="username" class="col-md-4 control-label">Photo</label>

                            <div class="col-md-6">
                                <input id="username" type="file" class="form-control" name="username" required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select name="type" id="type">
                                    ...
                                    <option value="client">Gestionnaire Client</option>
                                    <option value="cash">Comptable</option>
                                </select>
                            </div>
                        </div>
