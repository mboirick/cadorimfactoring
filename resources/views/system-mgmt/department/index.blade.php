...
@section('action-content')
  ...
  <div class="box-header">
    <div class="row">
        ...
        <div class="col-sm-4">
          <a class="btn btn-success" href="{{ route('department.create') }}">Ajouter une nouvelle ville</a>
        </div>
    </div>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('department.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['Nom'], 
          'oldVals' => [isset($searchingVals) ? $searchingVals['Nom'] : '']])
          @endcomponent
        @endcomponent
      </form>
      ...
      <div class="row">
        <div class="col-sm-12">
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                <th width="40%" class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending">Nom de la ville</th>
            ...
            <tfoot>
              <tr>
                <th width="40%" rowspan="1" colspan="1">Nom de la ville</th>
